...
OpenBoatUtils uses four plugin channels:
...
- [`openboatutils:keybinds`](/developers/keybinds) for server defined keybinds
- [`openboatutils:configuration`](/developers/configuration) for configuration phase versioning.

The context and keybind apis are optional, ignoring them will produce identical behaviour to before their introduction.
